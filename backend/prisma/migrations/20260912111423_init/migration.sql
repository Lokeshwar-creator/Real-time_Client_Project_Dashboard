...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('TASK_CREATED', 'TASK_ASSIGNED', 'STATUS_CHANGED', 'TASK_UPDATED');
...
-- CreateIndex
CREATE INDEX "tasks_developerId_priority_dueDate_idx" ON "tasks"("developerId", "priority", "dueDate");
...
-- AddForeignKey
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_developerId_fkey" FOREIGN KEY ("developerId") REFERENCES "users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
